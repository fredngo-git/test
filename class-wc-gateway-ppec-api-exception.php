...
require_once( 'class-wc-gateway-ppec-api-error.php' );

/**
 * PayPal API Exception.
 */
class MEcom_PayPal_API_Exception extends Exception {
	...
	public function __construct( $response ) {
		...
		foreach ( $errors as $value ) {
			$error = new MEcom_PayPal_API_Error( $value['code'], $value['message'], $value['long'], $value['severity'] );
			$this->errors[] = $error;
